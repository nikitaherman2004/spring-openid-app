...
public class UserController {
    ...
    @GetMapping("/current")
    public AppUserResponseDto getCurrentAppUser(@AuthenticationPrincipal OidcAuthenticationToken authenticationToken) {
        return appUserService.getCurrentAppUser(authenticationToken.getSub());
    }
